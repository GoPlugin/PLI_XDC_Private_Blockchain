...
function help() {
    ...
    echo "    NOTE: For node id, check your nodes/ directory, in which you should have the node ids as sub directory"
    echo
}
...
######################################################################################################################################################################
# Before restarting, check your variable value in "start-3-signers-networks.sh | start-2-signers-networks.sh" are similar to the variable values mentioned below. 
######################################################################################################################################################################
VERBOSITY=4
GAS_PRICE=1
NETWORK_ID=888
